...
public class SendSms {
    ...
    public static boolean push(String secretId,String secretKey
            ,String sendTemplateId,String[] phoneNumberSet,String[] templateParamSet){
        ...
        try {
            ...
            String sdkAppId = Constants.SDK_APPID;
            req.setSmsSdkAppId(sdkAppId);

            /* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名，签名信息可登录 [短信控制台] 查看 */
            String signName = Constants.SIGN_NAME;
...
//            String templateId = "400000";
            req.setTemplateId(sendTemplateId);
